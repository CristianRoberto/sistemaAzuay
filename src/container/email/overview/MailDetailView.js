              ...
              <div className="message-attachments">
                <figure>
                  <div className="attachment-image">
                    <img src={require('../../../assets/img/email/2.png')} alt="" />
                  </div>
                ...
                <figure>
                  <div className="attachment-image">
                    <img src={require('../../../assets/img/email/1.png')} alt="" />
                  </div>
                  <div className="attachment-hover">
                    <Link className="btn-link" to="#">
                      <FeatherIcon icon="download" />
                ...
                <figure>
                  <div className="attachment-image">
                    <img src={require('../../../assets/img/email/3.png')} alt="" />
                  </div>
                  <div className="attachment-hover">
                    <Link className="btn-link" to="#">
                      <FeatherIcon icon="download" />
                ...
                <figure>
                  <div className="attachment-image">
                    <img src={require('../../../assets/img/email/4.png')} alt="" />
                  </div>
                  <div className="attachment-hover">
                    <Link className="btn-link" to="#">
                      <FeatherIcon icon="download" />
            ...
            <ReplyList>
              <div className="reply-view__single">
                <figure className="reply-view__content d-flex">
                  <img style={{ width: 50, height: 50 }} src={require('../../../assets/img/email/2.png')} alt="" />
                  <figcaption>
                        ...
                        render={value => (
                          <>
                            <img
                              ...
                              src={require('../../../assets/img/email/2.png')}
                              alt=""
                            />
