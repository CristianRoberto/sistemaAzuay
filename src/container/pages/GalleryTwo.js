      ...
      <Main>
        <Row gutter={25}>
          ...
          <Masonry breakpointCols={4} className="my-masonry-grid" columnClassName="my-masonry-grid_column">
            {/* <img style={{ width: '100%' }} src={require(`../../assets/img/profile/cover-img.png`)} alt="" />
            <img style={{ width: '100%' }} src={require(`../../assets/img/gallery/2.png`)} alt="" />
            <img style={{ width: '100%' }} src={require(`../../assets/img/gallery/3.png`)} alt="" />
            <img style={{ width: '100%' }} src={require(`../../assets/img/gallery/4.png`)} alt="" />
            <img style={{ width: '100%' }} src={require(`../../assets/img/gallery/5.png`)} alt="" />
            <img style={{ width: '100%' }} src={require(`../../assets/img/gallery/6.png`)} alt="" /> */}
            {/* {gallery.map(item => {
