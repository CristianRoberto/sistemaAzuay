          ...
          steps={[
            {
              ...
              icon: <ReactSVG src={require('../../../../assets/img/icon/user.svg')} />,
              content: (
            ...
            },
            {
              ...
              className: 'wizard-step-item',
              icon: <ReactSVG src={require('../../../../assets/img/icon/address.svg')} />,
              content: (
                <BasicFormWrapper className="basic-form-inner">
                  <div className="atbd-form-checkout">
                    <Row justify="center">
            ...
            },
            {
              ...
              className: 'wizard-step-item',
              icon: <ReactSVG src={require('../../../../assets/img/icon/155-credit-card.svg')} />,
              content: (
                <BasicFormWrapper className="basic-form-inner">
                  <div className="atbd-form-checkout">
                    <Row justify="center">
            ...
            },
            {
              title: 'Review Order',
              className: 'wizard-step-item',
              icon: <ReactSVG src={require('../../../../assets/img/icon/024-like.svg')} />,
              content:
                status !== 'finish' ? (
