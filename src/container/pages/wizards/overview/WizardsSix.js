            ...
            steps={[
              {
                title: (
                  <div className="wizard-item">
                    ...
                    <img src={require('assets/img/wizards/1.svg')} alt="" />
                  </div>
                ),
                content: (
                      ...
                      <Row justify="center">
                        <Col xs={24}>
                          <div className="create-account-form">
                            <Heading as="h4">1. Nombre de Usuario</Heading>
                            <Form form={form} name="account">
                              <Form.Item name="idUser" label="Nombre de Usuario"
                                rules={[
                                  {
                                    min: 6,
                                    message: 'Ingrese un nombre de usuario valido. Minimo 6 caracteres',
                                  },
                                ]}>
                                <Input placeholder="Username" />
                              </Form.Item>  
                              <span className="color-primary">* Campos obligatorios</span>
                            </Form>
                          </div>
                        </Col>
                      </Row>
              ...
              },
              {
                title: (
                  <div className="wizard-item">
                    ...
                    <p>Lorem Ipsum is simply dummy text of the dummy typesetting industry.</p>
                    <img src={require('../../../../assets/img/wizards/1-1.svg')} alt="" />
                  </div>
                ),
                content: (
                  <BasicFormWrapper className="basic-form-inner">
              ...
              },
              {
                title: (
                  <div className="wizard-item">
                    ...
                    <p>Lorem Ipsum is simply dummy text of the dummy typesetting industry.</p>
                    <img src={require('../../../../assets/img/wizards/2.svg')} alt="" />
                  </div>
                ),
                content: (
                  <BasicFormWrapper className="basic-form-inner">
                              ...
                              <Radio.Group style={{ width: '100%' }}>
                                    ...
                                    >
                                      <div className="supported-card d-flex">
                                        ...
                                        <div className="supported-card_logos">
                                          ...
                                          <img
                                            style={{ width: '50px' }}
                                            src={require('../../../../assets/img/cards-logo/american-express.png')}
                                            alt=""
                                          />
                                          <img
                                            style={{ width: '50px' }}
                                ...
                                <div className="shipping-selection__paypal">
                                  <Radio value="payPal" style={{ width: '100%' }}>
                                    Pay With PayPal
                                    <img src={require('../../../../assets/img/PayPalLogo.png')} alt="paypal" />
                                  </Radio>
                                </div>
              ...
              },
              {
                title: (
                  <div className={`wizard-item ${status === 'finish' && 'block'}`}>
                    ...
                    <img src={require(`../../../../assets/img/wizards/${status !== 'finish' ? 3 : 4}.svg`)} alt="" />
                  </div>
                ),
                content:
                  status !== 'finish' ? (
                              ...
                              <Radio.Group style={{ width: '100%' }}>
                                <Radio value="ms" style={{ width: '100%' }}>
                                  <div className="method-info">
                                    <img src={require('../../../../assets/img/ms.svg')} alt="" />
                                    **** **** **** 2597
                                  </div>
                                </Radio>
                              </Radio.Group>
