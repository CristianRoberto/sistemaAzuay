...
const WizardWrapper = Styled.div`
    ...
    .ant-steps-item-container{
        ...
        &:after{
            ...
            top: 20px;
            color: #333;
            background-image: url(${require('../../../assets/img/progress.svg')});
            width: 114%;
            height: 6px;
    ...
    .wizard-steps-item-active{
        .ant-steps-item-container{
            &:after{
                background-image: url(${require('../../../assets/img/progress-active.svg')});
            }
        }
    }
    .success-step-item{
        .ant-steps-item-container{
            &:after{
                background-image: url(${require('../../../assets/img/progress-success.svg')});
            }
        }
    }
    .ant-steps-item{
