                ...
                <Row align="middle">
                  ...
                  <Col lg={8} sm={10} xs={24}>
                    <div className="sDash_support-img">
                      <img src={require(`../../assets/img/Group 9786.png`)} alt="" />
                    </div>
                  </Col>
                </Row>
              </div>
                    ...
                    <Col lg={8} xs={24}>
                      <div className="sDash-support-link-item">
                        <div className="sDash-support-link-item__icon primary">
                          <img src={require(`../../assets/img/icon/idea.svg`).default} alt="" />
                        </div>
                    ...
                    <Col lg={8} xs={24}>
                      <div className="sDash-support-link-item">
                        <div className="sDash-support-link-item__icon info">
                          <img src={require(`../../assets/img/icon/chat.svg`).default} alt="" />
                        </div>
                    ...
                    <Col lg={8} xs={24}>
                      <div className="sDash-support-link-item">
                        <div className="sDash-support-link-item__icon success">
                          <img src={require(`../../assets/img/icon/documentation.svg`).default} alt="" />
                        </div>
