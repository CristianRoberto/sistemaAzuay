...
function RecentFileTable({ folder }) {
  ...
  if (FileManagerData !== null) {
    ...
    //                 <img src={require(`../../../assets/img/files/pdf.png`)} alt="StrikingDash" />
    //               </div>
    ...
    //               <img src={require('../../../assets/img/users/1.png')} alt="strikingDash" />
    //               <img src={require('../../../assets/img/users/2.png')} alt="strikingDash" />
    //               <img src={require('../../../assets/img/users/3.png')} alt="strikingDash" />
    //               <img src={require('../../../assets/img/users/4.png')} alt="strikingDash" />
    //             </div>
    //           ),
    //           action: (
    //             <Dropdown
