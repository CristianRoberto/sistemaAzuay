    ...
    <Cards title="Files">
      <div className="file-list">
        <div className="file-list__single d-flex">
          <div className="file-single-info d-flex">
            <div className="file-single-logo">
              <img src={require(`../../../assets/img/files/zip.png`)} alt="File Logo" />
            </div>
        ...
        <div className="file-list__single d-flex">
          <div className="file-single-info d-flex">
            <div className="file-single-logo">
              <img src={require(`../../../assets/img/files/pdf.png`)} alt="File Logo" />
            </div>
            <div className="file-single__content">
        ...
        <div className="file-list__single d-flex">
          <div className="file-single-info d-flex">
            <div className="file-single-logo">
              <img src={require(`../../../assets/img/files/psd.png`)} alt="File Logo" />
            </div>
            <div className="file-single__content">
        ...
        <div className="file-list__single d-flex">
          <div className="file-single-info d-flex">
            <div className="file-single-logo">
              <img src={require(`../../../assets/img/files/jpg.png`)} alt="File Logo" />
            </div>
            <div className="file-single__content">
        ...
        <div className="file-list__single d-flex">
          <div className="file-single-info d-flex">
            <div className="file-single-logo">
              <img src={require(`../../../assets/img/files/png.png`)} alt="File Logo" />
            </div>
            <div className="file-single__content">
