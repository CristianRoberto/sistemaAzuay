      ...
      return dataSource.push({
        ...
        assigned: (
          <ProjectListAssignees>
            <ul>
              <li>
                <img src={require(`../../../assets/img/users/1.png`)} alt="" />
              </li>
              <li>
                <img src={require(`../../../assets/img/users/2.png`)} alt="" />
              </li>
              <li>
                <img src={require(`../../../assets/img/users/3.png`)} alt="" />
              </li>
              <li>
                <img src={require(`../../../assets/img/users/4.png`)} alt="" />
              </li>
              <li>
                <img src={require(`../../../assets/img/users/5.png`)} alt="" />
              </li>
              <li>
                <img src={require(`../../../assets/img/users/6.png`)} alt="" />
              </li>
              <li>
                <img src={require(`../../../assets/img/users/7.png`)} alt="" />
              </li>
            </ul>
          </ProjectListAssignees>
        ),
