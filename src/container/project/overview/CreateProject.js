        ...
        <BasicFormWrapper>
          <Form form={form} name="createProject" onFinish={handleOk}>
            ...
            <div className="projects-members mb-30">
              <img style={{ width: '35px' }} src={require(`../../../assets/img/users/1.png`)} alt="" />
              <img style={{ width: '35px' }} src={require(`../../../assets/img/users/2.png`)} alt="" />
              <img style={{ width: '35px' }} src={require(`../../../assets/img/users/3.png`)} alt="" />
              <img style={{ width: '35px' }} src={require(`../../../assets/img/users/4.png`)} alt="" />
              <img style={{ width: '35px' }} src={require(`../../../assets/img/users/5.png`)} alt="" />
            </div>
            <Row gutter={15}>
              <Col md={12}>
