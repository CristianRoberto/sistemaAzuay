...
const Banner6 = () => {
  return (
    <BannerWrapper>
      <Cards
        bodyStyle={{
          background: `url(${require('../../assets/img/banner/5.png')})`,
      ...
      >
        <Figure6>
          <img src={require('../../assets/img/banner/badge.svg')} alt="" />
          <figcaption>
            <h2>Up to 50 OFF</h2>
...
const Banner7 = () => {
  return (
    <BannerNormal className="theme-wide">
      <Cards headless>
        <Figure7>
          <img src={require('../../assets/img/banner/6.png')} alt="" />
          <figcaption>
      ...
      <Carousel autoplay>
        <div className="banner-signle">
          <div className="banner-single__img">
            <img src={require('../../assets/img/banner/8.png')} alt="" />
          </div>
  ...
  return (
    <BannerLongWrap>
      <div className="banner-long-inner">
        <h2>Up To Date </h2>
        <img src={require('../../assets/img/banner/9.png')} alt="" />
      </div>
    </BannerLongWrap>
  );
};
...
const BannerCard = () => {
  return (
    <BannerCardWrap>
      <div className="banner-card-inner" style={{backgroundImage: `url("${require('../../assets/img/banner/card-banner-1.png')}")`}}>
...
const BannerCard2 = () => {
  return (
    <BannerCardWrap>
      <div className="banner-card-inner theme-2" style={{backgroundImage: `url("${require('../../assets/img/banner/card-banner-2.png')}")`}}>
...
const BannerCta = () => {
  return (
    <BannerCtaWrap>
      <div className="banner-cta align-center-v" style={{backgroundImage: `url("${require('../../assets/img/banner/cta-banner-1.png')}")`}}>
...
const BannerCta2 = () => {
  return (
    <BannerCtaWrap>
      <div className="banner-cta align-center-v theme-2" style={{backgroundImage: `url("${require('../../assets/img/banner/cta-banner-2.png')}")`}}>
        <div className="banner-cta__content">
