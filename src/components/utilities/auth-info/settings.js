        ...
        <Row gutter="10">
          <Col sm={12}>
            <figure className="setting-dropdwon__single d-flex">
              <img src={require('../../../assets/img/icon/014-document.png')} alt="" />
              <figcaption>
          ...
          <Col sm={12}>
            <figure className="setting-dropdwon__single d-flex">
              <img src={require('../../../assets/img/icon/015-color-palette.png')} alt="" />
              <figcaption>
          ...
          <Col sm={12}>
            <figure className="setting-dropdwon__single d-flex">
              <img src={require('../../../assets/img/icon/010-home.png')} alt="" />
              <figcaption>
          ...
          <Col sm={12}>
            <figure className="setting-dropdwon__single d-flex">
              <img src={require('../../../assets/img/icon/017-video-camera.png')} alt="" />
              <figcaption>
          ...
          <Col sm={12}>
            <figure className="setting-dropdwon__single d-flex">
              <img src={require('../../../assets/img/icon/013-document-1.png')} alt="" />
              <figcaption>
          ...
          <Col sm={12}>
            <figure className="setting-dropdwon__single d-flex">
              <img src={require('../../../assets/img/icon/007-microphone-1.png')} alt="" />
              <figcaption>
