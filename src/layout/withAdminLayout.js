                ...
                <Col lg={!topMenu ? 4 : 3} sm={6} xs={12} className="align-center-v navbar-brand">
                  {!topMenu || window.innerWidth <= 991 ? (
                    <Button type="link" onClick={toggleCollapsed}>
                      <img src={require(`../assets/img/icon/${collapsed ? 'right.svg' : 'left.svg'}`)} alt="menu" />
                    </Button>
                  ) : null}
                  <Link
                  ...
                  >
                    <img
                      src={
                        !darkMode
                          ? require(`../assets/img/Logo_Dark.svg`).default
                          : require(`../assets/img/Logo_white.png`).default
                      }
                      alt=""
                    />
                  </Link>
                  ...
                  <ul className="customizer-list d-flex">
                    <li className="customizer-list__item">
                      <Link
                        ...
                        to="#"
                      >
                        <img src={require('../assets/img/ltr.png')} alt="" />
                    ...
                    <li className="customizer-list__item">
                      <Link
                        ...
                        to="#"
                      >
                        <img src={require(`../assets/img/rtl.png`)} alt="" />
                        <FontAwesome name="check-circle" />
                      </Link>
                    </li>
                  </ul>
                  ...
                  <ul className="customizer-list d-flex">
                    <li className="customizer-list__item">
                      <Link
                        ...
                        to="#"
                      >
                        <img src={require('../assets/img/side.png')} alt="" />
                        <FontAwesome name="check-circle" />
                      </Link>
                    </li>
