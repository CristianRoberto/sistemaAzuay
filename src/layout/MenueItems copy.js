  ...
  return (
    ...
    >
      ...
      <Menu.Item
        icon={
          !topMenu && (
            <ReactSVG className="sDash_menu-item-icon" src={require('../assets/img/icon/columns.svg').default} />
          )
        }
        key="kanban"
      >
      ...
      <SubMenu
        ...
        icon={
          !topMenu && (
            <ReactSVG className="sDash_menu-item-icon" src={require('../assets/img/icon/repeat.svg').default} />
          )
        }
      ...
      <SubMenu
        key="knowledgebase"
        icon={
          !topMenu && <ReactSVG className="sDash_menu-item-icon" src={require('../assets/img/icon/book.svg').default} />
        }
      ...
      <Menu.Item
        icon={
          !topMenu && (
            <ReactSVG className="sDash_menu-item-icon" src={require('../assets/img/icon/headphone.svg').default} />
          )
        }
        key="support"
      >
